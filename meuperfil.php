        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item nav-item-financa">
              <a class="nav-link" href="investimento.html">Finanças e Investimentos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="mangas.html">Mangás</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tudo.html">Ver Tudo</a>
            </li>
          </ul>
