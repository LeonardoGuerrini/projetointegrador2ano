...
<head>
    ...
    <title>Meu Carrinho | Wissen Livraria</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">Wissen</a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Autoajuda</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Negócios</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Finanças e Investimentos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Mangás</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Ver Tudo</a>
              </li>
            </ul>
