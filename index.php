          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p>R$31,29</p>
                <button class="btnComprarCard">
                  <a href="principe.php" class="classComprarCard"
                    >Comprar
                    <span class="material-symbols-outlined shopping_cart"
                      >add_shopping_cart</span
                    ></a
            ...
            <div class="carousel-item" data-bs-interval="2000">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p>R$71,80</p>
                <button class="btnComprarCard">
                  <a href="itacoisa.php" class="classComprarCard"
                    >Comprar
                    <span class="material-symbols-outlined shopping_cart"
                      >add_shopping_cart</span
                    ></a
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p>R$27,70</p>
                <button class="btnComprarCard">
                  <a href="chaisawman.php" class="classComprarCard"
                    >Comprar
                    <span class="material-symbols-outlined shopping_cart"
                      >add_shopping_cart</span
                    ></a
            ...
            <div class="carousel-item" data-bs-interval="2000">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p>R$29,99</p>
                <button class="btnComprarCard">
                  <a href="berserk.php" class="classComprarCard"
                    >Comprar
                    <span class="material-symbols-outlined shopping_cart"
                      >add_shopping_cart</span
                    ></a
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-md-block">
                ...
                <p>R$26,49</p>
                <button class="btnComprarCard">
                  <a href="demon.php" class="classComprarCard"
                    >Comprar
                    <span class="material-symbols-outlined shopping_cart"
                      >add_shopping_cart</span
                    ></a
      ...
      <div class="divCategorias">
        ...
        <div id="carouselCategorias4" class="carousel carousel-dark slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
              <img
                src="Img/A Lei da Atração.svg"
                class="d-block w-10"
                alt="Invista em imóveis com pouco dinheiro"
              />
              <div class="carousel-caption d-md-block">
                <h5>A Lei da Atração</h5>
                <p>R$34,90</p>
                <button class="btnComprarCard">
                  <a href="#" class="classComprarCard"
                    >Comprar
